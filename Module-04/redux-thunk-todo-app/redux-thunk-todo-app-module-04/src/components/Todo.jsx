...
import {colorSelected, deleted, toggled} from "../redux/features/todos/actions.js";
import updateStatus from "../redux/features/todos/thunk/updateStatus.js";
import updateColor from "../redux/features/todos/thunk/updateColor.js";
import deleteTodo from "../redux/features/todos/thunk/deleteTodo.js";

const Todo = ({item}) =>{
    const dispatch = useDispatch();
    const {id, text, completed, color} = item || {};
