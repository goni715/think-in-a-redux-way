...
import {deleteItem} from "../redux/booking/actions.js";

const BookingItem = ({item, index}) => {
    const {id, from, to, date, guests, classed} = item || {};
    ...
    return (
        <>
            ...
            <tr className="lws-bookedTable text-black">
                ...
                <td className="px-6 py-4 text-center">
                    <span className="lws-bookedClass"> {classed} </span>
                </td>
                <td className="px-6 py-4 text-center">
                    <div className="flex justify-center gap-4">
                        <button onClick={handleDelete} className="lws-remove">
