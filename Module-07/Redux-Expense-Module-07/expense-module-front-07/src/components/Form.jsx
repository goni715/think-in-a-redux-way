...
import {createTransaction, updateTransaction} from "../redux/features/transaction/transactionSlice.js";
...
export default function Form() {
    ...
    return (
        <div className="form">
            ...
            {editMode && (
                <button onClick={cancelEditMode} className="btn cancel_edit">Cancel Edit</button>
            )
            }
        </div>
    );
